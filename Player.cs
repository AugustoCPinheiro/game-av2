...
public class Player : MonoBehaviour {
    ...
    private void Movement() {
        ...
        transform.Translate(Vector3.right * Time.deltaTime * _speedMultiplier * Input.acceleration.x); /* VG */
        transform.Translate(Vector3.up * Time.deltaTime * _speedMultiplier * Input.acceleration.y); /* VG */
